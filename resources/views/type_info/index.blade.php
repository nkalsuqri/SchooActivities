...
<div class="container">
    <h1> انواع الانشطة</h1>
    <a class="btn btn-success" href="javascript:void(0)" id="createNewProduct"> جديد  </a>
...
<script type="text/javascript">
  $(function () {
    ...
    $('body').on('click', '.editRow', function () {
      var id = $(this).data('id');
      $.get("{{ route('type-info.index') }}" +'/' + id +'/edit', function (data) {
          $('#modelHeading').html("تحرير");
          $('#saveBtn').val("edit");
          $('#ajaxModel').modal('show');
          $('#id').val(data.id);
          $('#code').val(data.code);
